...
function occoptr(gamma, C, H, I, freeze_occ, p)
...
#### Experimental ####
# DEMON
function orbopt_demon(gamma, C, H, I, p)
...
# ADAM
function orbopt_adam(gamma, C, H, I, p)
...
# ADABelief
function orbopt_adabelief(gamma, C, H, I, p)
...
# YOGI
function orbopt_yogi(gamma, C, H, I, p)
